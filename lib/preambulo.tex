...
\documentclass[
	...
	sumario=tradicional,	% Sumario com seções recuadas
...
\usepackage[bottom=2cm,top=3cm,left=3cm,right=5cm]{geometry}
...
\usepackage{subfigure}                              % Permite usar subfigures

% Definir altura de linhas das tabelas.
